...
export default function Home() {
  ...
  const signatureHTML = `
    <div style="display: flex; background-color: white; align-items: center; column-gap: 2rem; font-weight: 600;">
      <div style="width: 100%; max-width: 300px;">
        <img src="/logo.gif" alt="logo" style="width: 100%;" />
      </div>
      <div>
        <p>${formData.name ? formData.name : "Name"}</p>
        <p style="font-size: 0.7rem;">${formData.job ? formData.job : "Job"}</p>
